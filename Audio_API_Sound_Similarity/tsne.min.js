    ...
    return (function e(t, n, r) {
        ...
        1: [function(require, module, exports) {
            ...
            function compileCwise(r) {
                ...
                for (var o = 0; o < s.length; ++o) {
                    ...
                    } else if ("scalar" === a) e.scalarArgs.push(o), e.shimArgs.push("scalar" + o);
                    else if ("index" === a) {
        ...
        2: [function(require, module, exports) {
            ...
            function innerFill(r, n, e) {
                var s, a, o = r.length,
                    i = n.arrayArgs.length,
                    t = n.indexArgs.length > 0,
                    p = [],
                    h = [],
                    u = 0,
                    c = 0;
                ...
                for (a = 0; i > a; ++a)
                    for (s = 0; o > s; ++s) c = u, u = r[s], 0 === s ? h.push(["d", a, "s", s, "=t", a, "p", u].join("")) : h.push(["d", a, "s", s, "=(t", a, "p", u, "-s", c, "*t", a, "p", c, ")"].join(""));
            ...
            function processBlock(r, n, e) {
                for (var s = r.body, a = [], o = [], i = 0; i < r.args.length; ++i) {
                    var t = r.args[i];
                    if (!(t.count <= 0)) {
                        var p = new RegExp(t.name, "g"),
                            h = "",
                            u = n.arrayArgs.indexOf(i);
                        switch (n.argTypes[i]) {
                            case "offset":
                                var c = n.offsetArgIndex.indexOf(i),
                                    l = n.offsetArgs[c];
                                u = l.array, h = "+q" + c;
                            case "array":
                                h = "p" + u + h;
                                var f = "l" + i,
                                    g = "a" + u;
                                if (0 === n.arrayBlockIndices[u]) 1 === t.count ? "generic" === e[u] ? t.lvalue ? (a.push(["var ", f, "=", g, ".get(", h, ")"].join("")), s = s.replace(p, f), o.push([g, ".set(", h, ",", f, ")"].join(""))) : s = s.replace(p, [g, ".get(", h, ")"].join("")) : s = s.replace(p, [g, "[", h, "]"].join("")) : "generic" === e[u] ? (a.push(["var ", f, "=", g, ".get(", h, ")"].join("")), s = s.replace(p, f), t.lvalue && o.push([g, ".set(", h, ",", f, ")"].join(""))) : (a.push(["var ", f, "=", g, "[", h, "]"].join("")), s = s.replace(p, f), t.lvalue && o.push([g, "[", h, "]=", f].join("")));
                                else {
        ...
        3: [function(require, module, exports) {
            ...
            function createThunk(r) {
                ...
                ], i = [], p = [], t = 0; t < r.arrayArgs.length; ++t) {
                    var c = r.arrayArgs[t];
        ...
        4: [function(require, module, exports) {
            ...
            function preprocess(e) {
                ...
                for (var s = ["(", e, ")()"].join(""), p = esprima.parse(s, {
                    range: !0
                }), l = "_inline_" + PREFIX_COUNTER++ + "_", u = getArgNames(p), f = new Array(u.length), c = 0; c < u.length; ++c) f[c] = new CompiledArgument([l, "arg", c, "_"].join(""), !1, !1);
                ...
                var y = [],
                    ...
                    v = 2;
                ! function _(e, o) {
                    if (e.parent = o, "MemberExpression" === e.type) e.computed ? (_(e.object, e), _(e.property, e)) : "ThisExpression" === e.object.type ? t(e, n(e.property.name)) : _(e.object, e);
                    else {
                        ...
                        } else if ("Literal" === e.type) "string" == typeof e.value && t(e, i(e.value));
                        else {
                            if ("WithStatement" === e.type) throw new Error("cwise-parser: with() statements not allowed");
                            for (var g = Object.keys(e), h = 0, y = g.length; y > h; ++h)
                                if ("parent" !== g[h]) {
                                    var d = e[g[h]];
                                    if (d)
                                        if (d instanceof Array)
                                            for (var w = 0; w < d.length; ++w) d[w] && "string" == typeof d[w].type && _(d[w], e);
                                        else "string" == typeof d.type && _(d, e)
                                }
                        }
                    }
        ...
        5: [function(require, module, exports) {
            ...
            function createCWise(e) {
                ...
                for (var o = 0; o < REQUIRED_FIELDS.length; ++o)
                    if (!e[REQUIRED_FIELDS[o]]) throw new Error("cwise: Missing argument: " + REQUIRED_FIELDS[o]);
                return compile({
                    args: e.args,
            ...
            var parse = require("cwise-parser"),
                compile = require("cwise-compiler"),
        ...
        7: [function(require, module, exports) {
            ...
            function dupe_array(e, r, u) {
                ...
                if (u === e.length - 1)
                    ...
                    for (t = 0; n > t; ++t) a[t] = dupe_array(e, r, u + 1);
                return a
            }
            ...
            ! function(e, t) {
                ...
                function p(e) {
                    ...
                    for (t = lt - e, n = {
                        ...
                        if (r = ct.charCodeAt(lt), ++lt, o(r)) return ht.comments && (a = ct.slice(t + e, lt - 1), n.end = {
                            line: st,
                            column: lt - mt - 1
                ...
                function y() {
                    ...
                    for (ht.comments && (e = lt - 2, t = {
                        ...
                        if (n = ct.charCodeAt(lt), o(n)) 13 === n && 10 === ct.charCodeAt(lt + 1) && ++lt, ++st, ++lt, mt = lt, lt >= dt && K({}, at.UnexpectedToken, "ILLEGAL");
                        else if (42 === n) {
                ...
                function h() {
                    var e, t;
                    for (t = 0 === lt; dt > lt;)
                        if (e = ct.charCodeAt(lt), i(e)) ++lt;
                        else if (o(e)) ++lt, 13 === e && 10 === ct.charCodeAt(lt) && ++lt, ++st, mt = lt, t = !0;
                        else if (47 === e)
                            if (e = ct.charCodeAt(lt + 1), 47 === e) ++lt, ++lt, p(2), t = !0;
                            else {
                                if (42 !== e) break;
                                ++lt, ++lt, y()
                            }
                ...
                function w() {
                    ...
                    if ("e" === i || "E" === i)
                        if (e += ct[lt++], i = ct[lt], ("+" === i || "-" === i) && (e += ct[lt++]), n(ct.charCodeAt(lt)))
                            for (; n(ct.charCodeAt(lt));) e += ct[lt++];
                        else K({}, at.UnexpectedToken, "ILLEGAL");
                ...
                function I() {
                    ...
                    for (l = st, s = mt, e = ct[lt], t("'" === e || '"' === e, "String literal must starts with a quote"), n = lt, ++lt; dt > lt;) {
                        ...
                        if ("\\" === r)
                            if (r = ct[lt++], r && o(r.charCodeAt(0))) ++st, "\r" === r && "\n" === ct[lt] && ++lt, mt = lt;
                            else switch (r) {
                                case "u":
                                case "x":
                ...
                function A() {
                    var e, n, r, a, i;
                    for (e = ct[lt], t("/" === e, "Regular expression literal must start with a slash"), n = ct[lt++], r = !1, a = !1; dt > lt;)
                        if (e = ct[lt++], n += e, "\\" === e) e = ct[lt++], o(e.charCodeAt(0)) && K({}, at.UnterminatedRegExp), n += e;
                        else if (o(e.charCodeAt(0))) K({}, at.UnterminatedRegExp);
                        else if (r) "]" === e && (r = !1);
                        else {
                            if ("/" === e) {
                                a = !0;
                    ...
                    return a || K({}, at.UnterminatedRegExp), i = n.substr(1, n.length - 2), {
                        value: i,
                        literal: n
                    }
                }
                ...
                function P() {
                    var e, t, n, r;
                    for (t = "", n = ""; dt > lt && (e = ct[lt], u(e.charCodeAt(0)));)
                        if (++lt, "\\" === e && dt > lt)
                            if (e = ct[lt], "u" === e) {
                                if (++lt, r = lt, e = S("u"))
                                    for (n += e, t += "\\u"; lt > r; ++r) t += ct[r];
                                else lt = r, n += "u", t += "\\u";
                ...
                function M(e) {
                    if (e.type === _e.EOF && K(e, at.UnexpectedEOS), e.type === _e.NumericLiteral && K(e, at.UnexpectedNumber), e.type === _e.StringLiteral && K(e, at.UnexpectedString), e.type === _e.Identifier && K(e, at.UnexpectedIdentifier), e.type === _e.Keyword) {
                        if (l(e.value)) K(e, at.UnexpectedReserved);
                        else if (ut && s(e.value)) return void V(e, at.StrictReservedWord);
                ...
                function re() {
                    ...
                    if (z("[")) return Y();
                    if (z("{")) return te();
                    if (e = pt.type, r = pt, e === _e.Identifier) n = ft.createIdentifier(D().value);
                    else if (e === _e.StringLiteral || e === _e.NumericLiteral) ut && pt.octal && V(pt, at.StrictOctalLiteral), n = ft.createLiteral(D());
                    else if (e === _e.Keyword) {
                ...
                function le() {
                    ...
                    for (r = pt, yt.allowIn = !0, e = $("new") ? ue() : re();;) {
                        if (z(".")) n = oe(), e = ft.createMemberExpression(".", e, n);
                        else if (z("(")) t = ae(), e = ft.createCallExpression(e, t);
                        else {
                            if (!z("[")) break;
                ...
                function pe() {
                    ...
                    for (r.prec = a, D(), t = [e, pt], o = de(), i = [u, r, o];
                         (a = fe(pt, yt.allowIn)) > 0;) {
                ...
                function He(e) {
                    var t, n, r, a, i, o, c = [];
                    if (H("("), !z(")"))
                        for (a = {}; dt > lt && (n = pt, t = ke(), i = "$" + n.value, ut ? (m(n.value) && (r = n, o = at.StrictParamName), Object.prototype.hasOwnProperty.call(a, i) && (r = n, o = at.StrictParamDupe)) : e || (m(n.value) ? (e = n, o = at.StrictParamName) : s(n.value) ? (e = n, o = at.StrictReservedWord) : Object.prototype.hasOwnProperty.call(a, i) && (e = n, o = at.StrictParamDupe)), c.push(t), a[i] = !0, !z(")"));) H(",");
                    return H(")"), {
                        params: c,
                        stricted: r,
                        firstRestricted: e,
                ...
                _e = {
                    ...
                    createArrayExpression: function(e) {
                        return {
                            type: nt.ArrayExpression,
                            elements: e
                        }
                    },
                    createAssignmentExpression: function(e, t, n) {
                        return {
                            type: nt.AssignmentExpression,
                            operator: e,
                            left: t,
                            right: n
                        }
                    ...
                    createContinueStatement: function(e) {
                        return {
                            type: nt.ContinueStatement,
                            label: e
                        }
                    },
                    createDebuggerStatement: function() {
                        return {
                            type: nt.DebuggerStatement
                        }
                    },
                    createDoWhileStatement: function(e, t) {
                        return {
                            type: nt.DoWhileStatement,
                            body: e,
                            test: t
                        }
                    },
                    createEmptyStatement: function() {
                        return {
                            type: nt.EmptyStatement
                        }
                    },
                    createExpressionStatement: function(e) {
                        return {
                            type: nt.ExpressionStatement,
                            expression: e
                        }
                    },
                    ...
                    createLiteral: function(e) {
                        return {
                            type: nt.Literal,
                            value: e.value,
                            raw: ct.slice(e.start, e.end)
                        }
                    },
                    createMemberExpression: function(e, t, n) {
                        return {
                            type: nt.MemberExpression,
                            computed: "[" === e,
                            object: t,
                            property: n
                        }
                    ...
                    createReturnStatement: function(e) {
                        return {
                            type: nt.ReturnStatement,
                            argument: e
                        }
                    },
                    createSequenceExpression: function(e) {
                        return {
                            type: nt.SequenceExpression,
                            expressions: e
                        }
                    },
        ...
        9: [function(require, module, exports) {
            ...
            module.exports = EventEmitter, EventEmitter.EventEmitter = EventEmitter, EventEmitter.prototype._events = void 0, EventEmitter.prototype._maxListeners = void 0, EventEmitter.defaultMaxListeners = 10, EventEmitter.prototype.setMaxListeners = function(e) {
                ...
                if (isFunction(n)) switch (arguments.length) {
                    ...
                    for (s = Array.prototype.slice.call(arguments, 1), o = n.slice(), i = o.length, r = 0; i > r; r++) o[r].apply(this, s);
                return !0
                ...
                if (n = this._events[e], s = n.length, i = -1, n === t || isFunction(n.listener) && n.listener === t) delete this._events[e], this._events.removeListener && this.emit("removeListener", e, t);
                else if (isObject(n)) {
                    for (r = s; r-- > 0;)
        ...
        13: [function(require, module, exports) {
            ...
            var ndarray = require("ndarray"),
                do_convert = require("./doConvert.js");
        ...
        15: [function(require, module, exports) {
            "use strict";
            var dup = require("dup"),
                do_unpack = require("cwise/lib/wrapper")({
                    args: ["array", "scalar", "index"],
                    pre: {
                        body: "{}",
                        args: [],
        ...
        16: [function(require, module, exports) {
            ...
            var iota = require("iota-array"),
                ...
                hasTypedArrays = "undefined" != typeof Float64Array,
                CACHED_CONSTRUCTORS = {
                    float32: [],
                    float64: [],
                    int8: [],
        ...
        17: [function(require, module, exports) {
            ...
            function unique_pred(n, e) {
                for (var u = 1, t = n.length, i = n[0], r = n[0], o = 1; t > o; ++o)
                    if (r = i, i = n[o], e(i, r)) {
                        if (o === u) {
                            u++;
                            continue
            ...
            function unique_eq(n) {
                for (var e = 1, u = n.length, t = n[0], i = n[0], r = 1; u > r; ++r, i = t)
                    if (i = t, t = n[r], t !== i) {
                        if (r === e) {
                            e++;
                            continue
        ...
        18: [function(require, module, exports) {
            ...
            var _slicedToArray = function() {
                ...
                _ndarray = require("ndarray"),
                _ndarray2 = _interopRequireDefault(_ndarray),
                _ndarrayOps = require("ndarray-ops"),
                _ndarrayOps2 = _interopRequireDefault(_ndarrayOps),
                _ndarrayPack = require("ndarray-pack"),
                _ndarrayPack2 = _interopRequireDefault(_ndarrayPack),
                _ndarrayUnpack = require("ndarray-unpack"),
                _ndarrayUnpack2 = _interopRequireDefault(_ndarrayUnpack),
                _cwise = require("cwise"),
                _cwise2 = _interopRequireDefault(_cwise),
                _randn = require("./randn"),
                _randn2 = _interopRequireDefault(_randn),
                ...
                _klDivergence = require("./kl-divergence"),
                _klDivergence2 = _interopRequireDefault(_klDivergence),
                TSNE = function(e) {
                    function t(e) {
                    ...
                    return _inherits(t, e), _createClass(t, [{
                        ...
                        value: function(e) {
                            ...
                            var t = e.data || [],
                                r = e.type || "dense";
                            if ("dense" === r) this.inputData = (0, _ndarrayPack2["default"])(t);
                            else {
                        ...
                        value: function() {
                            ...
                            var u = this._gradDesc(t + 1, this.nIter, .8, 1e-6, 1e-6),
                                s = _slicedToArray(u, 2);
                        ...
                        value: function(e, t, r) {
                            ...
                            var l = (0, _ndarray2["default"])(s, this.outputEmbedding.shape),
                                d = Number.MAX_VALUE,
                                p = Number.MAX_VALUE,
                                c = 0,
                                f = (0, _cwise2["default"])({
                            ...
                            for (h = e; t > h; h++) {
                                var _ = (0, _klDivergence2["default"])(this.outputEmbedding, this.P, this.alpha),
                                    m = _slicedToArray(_, 2),
                                    g = m[0],
                                    b = m[1],
                                    v = Math.abs(g - d);
                                d = g;
                                var w = f(b);
                                if (this.emit("progressIter", [h, d, w]), p > d) p = d, c = h;
                                else if (h - c > n) break;
                                if (a >= w) break;
                                if (i >= v) break;
        ...
        20: [function(require, module, exports) {
            ...
            Object.defineProperty(exports, "__esModule", {
                value: !0
            }), exports["default"] = function(a, r, e) {
                var d = a.shape[0],
                    s = a.shape[1],
                    t = (0, _ndarray2["default"])(new Float64Array(d * d), [d, d]),
        ...
        21: [function(require, module, exports) {
            ...
            Object.defineProperty(exports, "__esModule", {
                ...
                var a = t.shape[0],
                    e = (0, _ndarray2["default"])(new Float64Array(a * a), [a, a]);
                switch (r) {
                    case "euclidean":
                        for (var i = 0; a > i; i++)
                            for (var s = i + 1; a > s; s++) {
