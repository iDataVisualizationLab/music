...
export const createNativeConvolverNodeFactory = (createNativeAudioNode, createNativeConvolverNodeFaker, createNotSupportedError, testConvolverNodeBufferReassignabilitySupport) => {
    return (nativeContext, options) => {
        // Bug #116: Opera does not allow to reassign the buffer
        if (!cacheTestResult(testConvolverNodeBufferReassignabilitySupport, () => testConvolverNodeBufferReassignabilitySupport(nativeContext))) {
