...
const createNativeConvolverNode = createNativeConvolverNodeFactory(createNativeAudioNode, createNativeConvolverNodeFaker, createNotSupportedError, testConvolverNodeBufferReassignabilitySupport);
...
const createNativePannerNodeFaker = createNativePannerNodeFakerFactory(createNativeAudioNode, createNativeChannelMergerNode, createNativeGainNode, createNativeScriptProcessorNode, createNativeWaveShaperNode, createNotSupportedError);
const createNativePannerNode = createNativePannerNodeFactory(createInvalidStateError, createNativeAudioNode, createNativePannerNodeFaker);
const createPannerNodeRenderer = createPannerNodeRendererFactory(createNativePannerNode);
const pannerNodeConstructor = createPannerNodeConstructor(createAudioParam, createInvalidStateError, createNativePannerNode, createPannerNodeRenderer, isNativeOfflineAudioContext, noneAudioDestinationNodeConstructor);
