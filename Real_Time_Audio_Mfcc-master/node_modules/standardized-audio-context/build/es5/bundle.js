(function (global, factory) {
    ...
    function () {
      ...
      _createClass(EventTarget, [{
        ...
        options) {
          var wrappedEventListener = wrapEventListener(this, listener);
    ...
    var createIsSupportedPromise = function createIsSupportedPromise(browsernizr, testAudioContextCloseMethodSupport, testAudioContextDecodeAudioDataMethodTypeErrorSupport, testAudioContextOptionsSupport, testAudioWorkletProcessorNoOutputsSupport, testChannelMergerNodeSupport, testChannelSplitterNodeChannelCountSupport, testConstantSourceNodeAccurateSchedulingSupport, testIsSecureContextSupport, testStereoPannerNodeDefaultValueSupport, testTransferablesSupport) {
    ...
    var createNativeConvolverNodeFactory = function createNativeConvolverNodeFactory(createNativeAudioNode, createNativeConvolverNodeFaker, createNotSupportedError, testConvolverNodeBufferReassignabilitySupport) {
      return function (nativeContext, options) {
        // Bug #116: Opera does not allow to reassign the buffer
        if (!cacheTestResult(testConvolverNodeBufferReassignabilitySupport, function () {
          return testConvolverNodeBufferReassignabilitySupport(nativeContext);
        })) {
    ...
    var createNativeConvolverNodeFakerFactory = function createNativeConvolverNodeFakerFactory(createNativeAudioNode, createNativeGainNode) {
      return function (nativeContext, _a) {
        var buffer = _a.buffer,
            disableNormalization = _a.disableNormalization,
            audioNodeOptions = tslib_1.__rest(_a, ["buffer", "disableNormalization"]);
        ...
        inputGainNode.connect(convolverNode).connect(outputGainNode);
        var nativeConvolverNodeFaker = {
          ...
          set buffer(value) {
            if (convolverNode.buffer !== null) {
              ...
              var normalize = convolverNode.normalize;
              convolverNode = createNativeAudioNode(nativeContext, function (ntvCntxt) {
                return ntvCntxt.createConvolver();
              });
    ...
    var createNativePannerNodeFactory = function createNativePannerNodeFactory(createInvalidStateError, createNativeAudioNode, createNativePannerNodeFaker) {
      return function (nativeContext, options) {
    ...
    var createNativePannerNodeFakerFactory = function createNativePannerNodeFakerFactory(createNativeAudioNode, createNativeChannelMergerNode, createNativeGainNode, createNativeScriptProcessorNode, createNativeWaveShaperNode, createNotSupportedError) {
      return function (nativeContext, _a) {
    ...
    var createPannerNodeConstructor = function createPannerNodeConstructor(createAudioParam, createInvalidStateError, createNativePannerNode, createPannerNodeRenderer, isNativeOfflineAudioContext, noneAudioDestinationNodeConstructor) {
      return (
        /*#__PURE__*/
        function (_noneAudioDestination) {
          ...
          _createClass(PannerNode, [{
            ...
            set: function set(value) {
              var previousChannelCount = this._nativePannerNode.coneOuterGain;
              this._nativePannerNode.coneOuterGain = value; // Bug #127: Edge, Opera & Safari do not throw an InvalidStateError yet.
            ...
            set: function set(value) {
              var previousRolloffFactor = this._nativePannerNode.rolloffFactor;
              this._nativePannerNode.rolloffFactor = value; // Bug #130: Edge, Opera & Safari do not throw a RangeError yet.
    ...
    var createTestConvolverNodeBufferReassignabilitySupport = function createTestConvolverNodeBufferReassignabilitySupport(createNativeAudioNode) {
      return function (nativeContext) {
        var nativeConvolverNode = createNativeAudioNode(nativeContext, function (ntvCntxt) {
          return ntvCntxt.createConvolver();
        });
    ...
    var createNativeConvolverNodeFaker = createNativeConvolverNodeFakerFactory(createNativeAudioNode, createNativeGainNode);
    var testConvolverNodeBufferReassignabilitySupport = createTestConvolverNodeBufferReassignabilitySupport(createNativeAudioNode);
    var createNativeConvolverNode = createNativeConvolverNodeFactory(createNativeAudioNode, createNativeConvolverNodeFaker, createNotSupportedError, testConvolverNodeBufferReassignabilitySupport);
    ...
    var createNativePannerNodeFaker = createNativePannerNodeFakerFactory(createNativeAudioNode, createNativeChannelMergerNode, createNativeGainNode, createNativeScriptProcessorNode, createNativeWaveShaperNode, createNotSupportedError);
    var createNativePannerNode = createNativePannerNodeFactory(createInvalidStateError, createNativeAudioNode, createNativePannerNodeFaker);
    var createPannerNodeRenderer = createPannerNodeRendererFactory(createNativePannerNode);
    var pannerNodeConstructor = createPannerNodeConstructor(createAudioParam, createInvalidStateError, createNativePannerNode, createPannerNodeRenderer, isNativeOfflineAudioContext, noneAudioDestinationNodeConstructor);
